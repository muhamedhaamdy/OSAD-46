...
Uses ChatOpenAI / ChatOllama with LangChain prompt templates and message history.
"""
...
class ChefService:
    """Manages chef conversations using LangChain chat models, prompt templates, and message history."""
    ...
    def __init__(self):
        ...
        # LangChain message history — stores conversation as LangChain messages
    ...
    def _build_prompt(self):
        """Build a ChatPromptTemplate with the chef system prompt + chat history placeholder."""
    ...
    def _build_chain(self):
        """Create a LangChain LCEL chain: prompt | llm."""
        llm = self._build_llm()
    ...
    def reset_conversation(self):
        """Clear message history and rebuild the chain."""
    ...
    async def chat(self, user_message: str) -> str:
        ...
        try:
            # Invoke the LCEL chain with current history + new input
            ...
            # Update history with LangChain message types
            self.chat_history.append(HumanMessage(content=user_message))
            self.chat_history.append(AIMessage(content=assistant_reply))
